## V38.1 — AI structured-output schema fix
- [ ] Deploy V38.1.
- [ ] Re-run the semantic Copilot prompt.
- [ ] Confirm POST /api/copilot/interpret returns HTTP 200.
- [ ] Confirm the result metadata includes `AI`.
- [ ] No change to OPENAI_API_KEY is required.
