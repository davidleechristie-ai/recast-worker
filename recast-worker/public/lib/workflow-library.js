...
(function () {
  ...
  function render() {
    ...
    if (!items.length) {
      wrap.innerHTML = '<div class="wf-empty"><strong>Your reusable workflows will appear here.</strong><span>Build one above, then save it. Workflows stay in this browser until you choose to export or deploy them.</span></div>';
      return;
    }
