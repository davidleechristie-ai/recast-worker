...
export default {async fetch(request,env){
  ...
  const cleanRoutes={'/methodology':'/methodology.html','/waste-sales-intelligence':'/waste-sales-intelligence.html','/digital-waste-tracking-sales-intelligence':'/digital-waste-tracking-sales-intelligence.html','/dashboard-demo':'/dashboard-demo.html','/signals/new-waste-sites-september-2026':'/new-waste-sites-september-2026.html'};
