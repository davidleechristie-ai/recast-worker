(()=>{
  ...
  if(isDecision&&!q('#hqc-decision-entry')){
    ...
    bar.innerHTML='<span><b style="display:block">Already have a quote?</b><small style="font-weight:500;color:#64748b">Check the actual document, not just the averages.</small></span><a href="/?hqc_start=1" style="flex:0 0 auto;text-decoration:none;border-radius:9px;background:#087f5b;color:white;padding:11px 14px;font-weight:800;white-space:nowrap">Check my quote →</a>';
