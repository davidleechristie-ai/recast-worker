...
console.log(`HQC frontend snapshot complete for ${TARGET}: ${saved.size} fetched files + runtime dependencies + approved action-led results layout + Decision Pack checkout + comparison guide + local PDF rendering`);
