...
- PRODUCTION: no HQC production release made. Prior rendered recovery/router-isolation proof remains authoritative. Repository main moved for unrelated Recast work and was not treated as HQC production evidence.
- PRODUCT/SAFETY: re-inspected the Solar/Battery request boundary. PDF/image content still deliberately fails closed with HTTP 415 while structured/manual JSON remains verified. The trust gate was preserved; no unsupported extraction path was exposed.
- ROADMAP: no capability promoted to verified/live. PDF/image ingestion remains the next WS2/WS3 boundary, followed by technology propagation through durable funnel/checkout evidence. Solar remains non-public; Heat Pump unchanged.
- OPS/LEARNINGS.md unchanged: no new authoritative reusable customer/product lesson established.
- NEXT: implement trustworthy gated PDF/image ingestion and correctness tests, then technology propagation; continue qualified Heat Pump acquisition toward the first genuine £4.99 purchase.
